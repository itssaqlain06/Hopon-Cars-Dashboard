...
const AddNewCar: React.FC<AddNewCarProps> = ({ onClose, isOpen }) => {
    ...
    const [fleetType, setFleetType] = useState('No Uplift');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        formData.append('suit_cases', suitCases);
        formData.append('hand_bags', handBags);
        formData.append('status', status);
        formData.append('fleetType', fleetType);
        formData.append('fleetValue', fleetType === 'No Uplift' ? 'empty' : fleetValue);
