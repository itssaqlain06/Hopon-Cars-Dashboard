...
import { useAddUserMutation } from '../../redux/usersData/adminLogin';
...
const SignIn: React.FC<{ onSignIn: () => void }> = ({ onSignIn }) => {
  ...
  const [login, { isLoading }] = useAddUserMutation();
  ...
  return (
    <>
      <div className="flex-1 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark h-screen">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="hidden dark:block h-15" src={Logo} alt="Logo" />
                {/* <img className="dark:hidden h-10 w-20" src={Logo} alt="Logo" /> */}
              </Link>
              ...
              <form onSubmit={handleLogin}>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      <AiOutlineMail color="gray" size={25} />
                    </span>
                  </div>
                </div>
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value="Sign In"
                    className="w-full cursor-pointer rounded-lg border  bg-yellow-500 p-4 text-white transition hover:bg-yellow-600"
                    disabled={isLoading}
                  />
                </div>
              </form>
